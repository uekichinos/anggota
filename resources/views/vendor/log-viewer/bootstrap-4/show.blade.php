...
@section('content')
    <div class="card">
        <div class="card-header">
            <div class="float-left">Audit > Log Viewer > Logs > {{ $log->date }}</div>
                    ...
                    <div class="card mb-4">
                        <div class="list-group list-group-flush log-menu">
                            @foreach($log->menu() as $levelKey => $item)
                                @if ($item['count'] === 0)
                                    <a class="logviewer-leftp list-group-item list-group-item-action d-flex justify-content-between align-items-center disabled">
                                        <span class="level-name">{{ $item['name'] }}</span>
                                        <span class="badge empty">{{ $item['count'] }}</span>
                                    </a>
                                @else
                                    <a href="{{ $item['url'] }}" class="logviewer-leftp list-group-item list-group-item-action d-flex justify-content-between align-items-center level-{{ $levelKey }}{{ $level === $levelKey ? ' active' : ''}}">
                                        <span class="level-name">{{ $item['name'] }}</span>
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <div class="group-btns pull-right">
                                @can('view logviewer')
                                    <a href="{{ route('log-viewer::logs.list') }}" class="btn btn-secondary btn-sm">Back</a>
                        ...
                        <div class="table-responsive">
                            <table class="table table-condensed mb-0">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>@lang('Size') :</td>
                                        <td><span class="badge badge-primary">{{ $log->size() }}</span></td>
                                    </tr>
                                    <tr>
                                        <td>@lang('Created at') :</td>
                                        <td><span class="badge badge-primary">{{ $log->createdAt() }}</span></td>
                                    </tr>
                                    <tr>
