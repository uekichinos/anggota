...
class UserController extends Controller
{
    ...
    {
        $roles = Role::all();
        return view('user.create')->with(array('roles' => $roles));
    }
    ...
    public function show($id)
    {
        ...
        return view('user.show')->with(array('user' => $user, 'introducer' => $introducer));
    }
    ...
    public function edit($id)
    {
        ...
        return view('user.edit')->with(array('user' => $user, 'user_roles' => $user_roles, 'roles' => $roles));
    }
